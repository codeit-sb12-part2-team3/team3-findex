...
- 지수별 성과 분석, 이동평균선 계산, 시계열 차트 등의 기능을 통해 금융 지수들의 흐름을 직관적으로 확인할 수 있습니다.
- 관심 지수 등록, Open API 자동 연동 업데이트 기능을 통해 최신 금융 데이터를 빠르게 반영해 실용적으로 금융지수 정보를 제공합니다.
...
## 구현 홈페이지
[team3-findex-production.up.railway.app]
## 프로젝트 회고록
(발표 자료 링크 혹은 첨부파일)
